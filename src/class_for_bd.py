...
class DBManager:
    ...
    def get_all_vacancies(self) -> List[Tuple[str, str, Optional[float], Optional[float], Optional[str], str]]:
        ...
        Возвращает: список кортежей (компания, вакансия, зарплата_от, зарплата_до, валюта, ссылка)
        """
        if not self.conn:
            self.connect()
    ...
    def get_avg_salary(self) -> float:
        ...
        Возвращает: средняя зарплата (float), 0.0 если данных нет
        """
        if not self.conn:
            self.connect()
    ...
    def get_vacancies_with_higher_salary(self) -> List[Tuple]:
        ...
        Возвращает: список кортежей с данными вакансий (компания, вакансия, зарплата_от, зарплата_до, валюта, ссылка)
        """
        if not self.conn:
            self.connect()
